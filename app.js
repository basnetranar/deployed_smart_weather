...
//Get Users permission to detect the user's geo location.
		      ...
		      navigator.geolocation.watchPosition(
			      	function geo_success(position) {
					    ...
					    var longitude = position.coords.longitude;
			      		...
			      		$http.get('https://api.apixu.com/v1/forecast.json?key=831ba80bf1bf44dc9ba32019180305&q=' + latitude + ","+longitude+"&days=5")
	...
	$scope.getWeather = function(){
		...
		$http.get('https://api.apixu.com/v1/forecast.json?key=831ba80bf1bf44dc9ba32019180305&q=' + $scope.location+"&days=5")
		.then(function successCallback(response){
		$scope.getValues(response);
	},
		function errorCallback(response) {
